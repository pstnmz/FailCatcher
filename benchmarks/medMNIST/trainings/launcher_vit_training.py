...
use_randaugments = [True, True, True, True, True, True, True, True, True]  # <- enable/disable RandAugment here
...
num_epochs = 100
batch_size = 64            # <- ViT uses smaller batch size due to larger model
