...
into main new_class_shifts/figures, matching by dataset/backbone/setup.
"""
...
def main():
    ...
    parent_figures_dir = ncs_dir / 'figures'
    merge_figures_dir = ncs_dir / 'to_merge' / 'figures'
    
    print("=" * 80)
    print("Merging MCDropout Figures - NEW CLASS SHIFTS")
    print("=" * 80)
