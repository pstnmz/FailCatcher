...
def main():
    ...
    print("=" * 80)
    print("Recomputing Mean_Aggregation and Mean_Aggregation_Ensemble - IN-DISTRIBUTION")
    print("=" * 80)
    print(f"Directory: {in_dist_dir}")
    print(f"Methods: {', '.join(method_names)}")
    
    process_directory(in_dist_dir, method_names)
