...
into main in_distribution/figures, matching by dataset/backbone/setup.
"""
...
def main():
    ...
    parent_figures_dir = in_dist_dir / 'figures'
    merge_figures_dir = in_dist_dir / 'to_merge' / 'figures'
    
    print("=" * 80)
    print("Merging MCDropout Figures - IN-DISTRIBUTION")
    print("=" * 80)
