...
into main population_shifts result files, replacing old MCDropout data.
"""
...
def extract_file_key(filename: str) -> Tuple[str, str, str]:
    ...
    # Handle cases like dermamnist-e-external, vit_b_16
...
def main():
    ...
    parent_dir = pop_shifts_dir
    merge_dir = pop_shifts_dir / 'to_merge'
    
    print("=" * 80)
    print("Merging MCDropout Results (k=30) for POPULATION SHIFTS")
    print("=" * 80)
    
    # Test file key extraction
    test_files = [
        'uq_benchmark_amos2022_resnet18_20260115_063713.json',
        'uq_benchmark_amos2022_vit_b_16_DADO_20260118_141453.json',
        'all_metrics_dermamnist-e-external_resnet18_DO_20260115_100828.npz',
        'uq_benchmark_dermamnist-e-external_vit_b_16_DA_20260115_104450.json',
    ]
